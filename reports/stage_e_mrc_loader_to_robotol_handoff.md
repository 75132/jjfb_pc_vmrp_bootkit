...
[CROSS_MODULE_CALL] transfer_id=2 hop=DSM_TO_LOADER from_module=dsm:cfunction.ext from_module_id=5 from_pc=0xA2548 to_module=mrc_loader.ext to_module_id=2 target=0x2AEB34 target_offset=0x30 r0=0x0 r1=0x2AEB0C lr=0xA2548 evidence=OBSERVED
[R0_LAYER] stage=DSM_TO_DISPATCH r0=0x0 dispatch_module=mrc_loader.ext
[CHUNK_FIELD_04_WRITE] chunk_base=0x682A5C value=0x2AEB34 writer_module=NONE writer_offset=0x0 module=mrc_loader.ext note=NONE_BEFORE_SELECT
[DSM_ENTRY_SELECT] source=chunk_field_0x4 entry_va=0x2AEB34 entry_module=mrc_loader.ext entry_offset=0x30 registered_helper=0x2AEB48 header_entry_candidate=0x2AEB0C chunk_field_04=0x2AEB0C match=neither r0_source=explicit_zero r0_value=0x0 r1_target=0x2AEB34 caller_module=dsm:cfunction.ext caller_offset=0x22544 evidence=OBSERVED+DOCUMENTED_chunk_plus4 chunk_field_04_writer=NONE_BEFORE_SELECT chunk_base=0x682A5C chunk_reg=r0
[ENTRY_TRANSFER] dispatch_target=0x2AEB34 dispatch_module=mrc_loader.ext dispatch_offset=0x30 callee_module=mrc_loader.ext first_executed_pc=0x2AEB34 r0=0x0 stage=CALL_SITE_BEFORE raw_target=0x2AEB34
[ADDR_CLASS] role=entry_object_field_04 va=0x2AEB34 class=MODULE_CODE module=mrc_loader.ext offset=0x30 module_id=2
[ADDR_CLASS] role=dispatch_target va=0x2AEB34 class=MODULE_CODE module=mrc_loader.ext offset=0x30 module_id=2
[ENTRY_TRANSFER] dispatch_target=0x2AEB34 dispatch_module=mrc_loader.ext dispatch_offset=0x30 callee_module=mrc_loader.ext first_executed_pc=0x2AEB34 r0=0x0 stage=CALL_SITE_BEFORE equals_observed_first=1
[OBJECT_IDENTITY_CASE] case=A legend=A_loader_dispatcher|B_trampoline|C_base_wrong|D_descriptor_or_table|E_attrib_bug dispatch_module=mrc_loader.ext dispatch_offset=0x30 object_kind=FUNCTION_TABLE dsm_direct_robotol=no r0_at_dsm_blx=0x0 candidate_wrong=0 phase6b_b_gate=blocked
```
