...
当前唯一门锁：wrapper returned R0=2; parent path observed but UI schedule missing
下一处最小通用修复：continue parent branch chain; find first real blocking gate
```

## Evidence

- run_id=p22l_20260802_031506_5240
- cont=0x89BF0 ldm_rows=3 next_rows=3 slice_n=5
