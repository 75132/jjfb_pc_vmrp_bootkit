...
R0=2 consumed (scale_index_r0_2_in_SUB (r0=r1-(r0<<shift)); not boolean status) but no callback/+0x10740 schedule observed
...
当前唯一门锁：R0=2 consumed (scale_index_r0_2_in_SUB (r0=r1-(r0<<shift)); not boolean status) but no callback/+0x10740 schedule observed
下一处最小通用修复：identify natural producer of callback/+0xF670|+0x8CDC|+0xD978 after parent
```

## Evidence

- run_id=p22l_20260802_032012_57034
