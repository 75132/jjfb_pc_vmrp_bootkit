...
$e8oFast = ($env:JJFB_FAST_ASSIST -eq '1') -or ($env:JJFB_E8O_MODE -eq '1') -or ($env:JJFB_E8P_MODE -eq '1') -or ($env:JJFB_E8Q_MODE -eq '1') -or ($env:JJFB_E8R_MODE -eq '1') -or ($env:JJFB_E8S_MODE -eq '1') -or ($env:JJFB_E8T_MODE -eq '1') -or ($env:JJFB_E8U_MODE -eq '1') -or ($env:JJFB_E8V_MODE -eq '1') -or ($env:JJFB_E8W_MODE -eq '1') -or ($env:JJFB_E8X_MODE -eq '1') -or ($env:JJFB_E8Y_MODE -eq '1') -or ($env:JJFB_E8Z_MODE -eq '1') -or ($env:JJFB_E9A_MODE -eq '1') -or ($env:JJFB_E9B_MODE -eq '1') -or ($env:JJFB_E9C_MODE -eq '1') -or ($env:JJFB_E9D_MODE -eq '1') -or ($env:JJFB_E9E_MODE -eq '1') -or ($env:JJFB_E9F_MODE -eq '1') -or ($env:JJFB_E9G_MODE -eq '1') -or ($env:JJFB_E9H_MODE -eq '1') -or ($env:JJFB_E9I_MODE -eq '1') -or ($env:JJFB_E9J_MODE -eq '1') -or ($env:JJFB_E9K_MODE -eq '1') -or ($env:JJFB_E9L_MODE -eq '1') -or ($env:JJFB_E9M_MODE -eq '1') -or ($env:JJFB_E9N_MODE -eq '1') -or ($env:JJFB_E9O_MODE -eq '1') -or ($env:JJFB_E9P_MODE -eq '1') -or ($env:JJFB_E9Q_MODE -eq '1') -or ($env:JJFB_E9R_MODE -eq '1') -or ($env:JJFB_E9S_MODE -eq '1') -or ($env:JJFB_E9T_MODE -eq '1') -or ($env:JJFB_E9U_MODE -eq '1') -or ($env:JJFB_DISPLAY_FIRST -eq '1')
if ($e8oFast) {
  # FAST_ASSIST / E8P..E9U: do not stop on 30103C alone.
  ...
  $e9mMode = ($env:JJFB_E9M_MODE -eq '1') -or ($env:JJFB_E9N_MODE -eq '1') -or ($env:JJFB_E9O_MODE -eq '1') -or ($env:JJFB_E9P_MODE -eq '1') -or ($env:JJFB_E9Q_MODE -eq '1') -or ($env:JJFB_E9R_MODE -eq '1') -or ($env:JJFB_E9S_MODE -eq '1') -or ($env:JJFB_E9T_MODE -eq '1') -or ($env:JJFB_E9U_MODE -eq '1')
  ...
  if ($e9lMode -and $e9bMode) {
    ...
    # E9J: also wait for deferred hold after progress blits (not LOADING_UI alone).
    if ($e9jMode) {
      $stopPat = "JJFB_VISIBLE_WINDOW_HOLD_DONE\]|JJFB_E9J_CLASS\] class=SPLASH_TEXTBAR_DRAWN_NO_REWRITE|JJFB_E9H_CLASS\] class=SPLASH_BLIT_BAD_XY|JJFB_E9I_CLASS\] class=SPLASH_COORD_ASSIST_STILL_REQUIRED|UC_MEM_READ_UNMAPPED|UC_MEM_WRITE_UNMAPPED|mythroad exit|br_mem_get failed"
    } else {
      $stopPat = "JJFB_VISIBLE_WINDOW_HOLD_DONE\]|JJFB_E9J_CLASS\] class=SPLASH_LOADING_UI_VISIBLE|JJFB_E9J_CLASS\] class=SPLASH_PROGRESS_DRAWN_NO_REWRITE|JJFB_E9J_CLASS\] class=SPLASH_TEXTBAR_DRAWN_NO_REWRITE|JJFB_E9H_CLASS\] class=SPLASH_BLIT_BAD_XY|JJFB_E9I_CLASS\] class=SPLASH_COORD_ASSIST_STILL_REQUIRED|UC_MEM_READ_UNMAPPED|UC_MEM_WRITE_UNMAPPED|mythroad exit|br_mem_get failed"
    }
  } elseif ($e9kMode) {
    $stopPat = "JJFB_E9K_CLASS\] class=SPLASH_TEXTBAR_DRAWN_NO_REWRITE|JJFB_E9K_CLASS\] class=SPLASH_305BFC_REACHED_NEXT_GAP|JJFB_E9K_CLASS\] class=SPLASH_POST_R4_REACHED_NEXT_GAP|JJFB_E9K_CLASS\] class=SPLASH_POST_R4_BLOCKED_BY_|UC_MEM_READ_UNMAPPED|UC_MEM_WRITE_UNMAPPED|mythroad exit|br_mem_get failed"
  } elseif ($e9jMode) {
    $stopPat = "JJFB_E9J_CLASS\] class=SPLASH_LOADING_UI_VISIBLE|JJFB_E9J_CLASS\] class=SPLASH_PROGRESS_DRAWN_NO_REWRITE|JJFB_E9J_CLASS\] class=SPLASH_PROGRESS_OBJECT_ASSIST_REACHED_POST_R4|JJFB_E9J_R4_GATE\]|JJFB_E9H_CLASS\] class=SPLASH_BLIT_BAD_XY|UC_MEM_READ_UNMAPPED|UC_MEM_WRITE_UNMAPPED|mythroad exit|br_mem_get failed"
  } elseif (($e9iMode -or $e9hMode) -and $e9bMode) {
    # Prefer HWND hold after splash draw; do not kill on DRAWN/NATURAL alone.
  ...
  } elseif ($e9gMode -and $e9bMode) {
    # Splash UI + HWND: wait for hold or splash/request milestones (no rewrite success).
    $stopPat = "JJFB_VISIBLE_WINDOW_HOLD_DONE\]|JJFB_E9G_CLASS\] class=GAME_REQUESTED_|JJFB_FIRST_REAL_FRAME_REACHED\]|JJFB_VISIBLE_WINDOW\] class=WINDOW_CAPTURE_STILL_BLANK|JJFB_VISIBLE_WINDOW\] class=WINDOW_PRESENT_BLOCKED_|UC_MEM_READ_UNMAPPED|UC_MEM_WRITE_UNMAPPED|mythroad exit|br_mem_get failed"
  } elseif (($e9eMode -or $e9fMode) -and $e9bMode) {
    ...
    if ($e9fMode -and -not $e9gMode -and ($env:JJFB_E9F_REWRITE_REQUEST -ne '1')) {
