...
if ($e8oFast) {
  ...
  $e9mMode = ($env:JJFB_E9M_MODE -eq '1') -or ($env:JJFB_E9N_MODE -eq '1') -or ($env:JJFB_E9O_MODE -eq '1') -or ($env:JJFB_E9P_MODE -eq '1')
