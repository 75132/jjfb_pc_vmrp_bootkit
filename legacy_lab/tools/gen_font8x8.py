#!/usr/bin/env python3
"""Emit a compact 8x8 ASCII font (0x20-0x7E) as C static array."""
# Public-domain style 8x8 glyphs (column-major bits, MSB = left pixel).
# Digits / letters kept readable; rest are simple placeholders.
GL = {
    ...
    0x45: [0x7F, 0x06, 0x06, 0x3E, 0x06, 0x06, 0x7F, 0x00],
    0x46: [0x7F, 0x06, 0x06, 0x3E, 0x06, 0x06, 0x06, 0x00],
    ...
    0x4C: [0x06, 0x06, 0x06, 0x06, 0x06, 0x06, 0x7F, 0x00],
    ...
    0x50: [0x3F, 0x66, 0x66, 0x3E, 0x06, 0x06, 0x06, 0x00],
...
print("static const uint8_t jjfb_font8x8[95][8] = {")
for c in range(0x20, 0x7F):
    rows = GL.get(c, [0x7E, 0x42, 0x42, 0x42, 0x42, 0x42, 0x7E, 0x00])
    hexrows = ", ".join("0x%02X" % r for r in rows)
    ch = chr(c) if c != 0x5C else "\\\\"
    print("    {/* '%s' */ %s}," % (ch, hexrows))
print("};")
