...
typedef unsigned short		U16;      //有符号16bit整型
typedef unsigned long int	U32;      //无符号32bit整型
typedef unsigned char		U8;        //无符号8bit整型
typedef signed char         I8;        //有符号8bit整型
typedef signed short        I16;       //有符号16bit整型
typedef long int            I32;      //有符号32bit整型
