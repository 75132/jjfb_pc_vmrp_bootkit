...
/* mr_table._DispUpEx ??refresh dirty rect from mr_screenBuf. */
...
static void jjfb_hook_uimode_writer(uc_engine *uc, uint64_t address, uint32_t size, void *user_data) {
    ...
    case 0x3054A4:
        ...
        printf("[JJFB_V56_CALLBACK] register #%u pc=0x%X lr=0x%X "
               ...
               n_cb_register, (uint32_t)address, lr, r0, r1, r2, r3,
               (r3 == 0x2F5405 || r3 == 0x2F5404) ? " CALLBACK_2F5404" : "");
        break;
    case 0x2F5404:
        n_cb_entry++;
