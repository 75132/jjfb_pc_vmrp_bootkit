# JJFB / PC-vmrp 交接包（最新 · v33）

生成时间：2026-07-17（v33 真字素 + shadow gfx heal）  
...
下一步 = 放行 chrome 试 310bb4 / 资源路径 / 等原生 present。
```

**不要：** 编造 `sdk_key`、假冒 `mrc_refreshScreen`、回退 loader、用 UCRT64、整表替换 shadow→host mr_table。
