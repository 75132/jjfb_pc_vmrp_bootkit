...
Write-Host "== JJFB PC direct replace v4: gwy =="
python .\scripts\pc_direct_replace_v4.py prepare --mode gwy
...
python .\scripts\pc_direct_replace_v4.py launch --mode gwy
python .\scripts\pc_direct_replace_v4.py collect --mode gwy
