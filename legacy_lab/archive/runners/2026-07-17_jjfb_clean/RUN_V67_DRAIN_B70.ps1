# JJFB v67 - probe 2E2520 ret / 312C0C dequeue / 2FC26C alt (B70==0)
# Ref: v66 reached 2DADC4 via 2FC26C; same code=5 re-drains; B70 stays 0.
param(
  [int]$Seconds = 25,
  [switch]$SkipBuild,
...
$out = Join-Path $logDir "v67_drain_b70_stdout.txt"
$errOut = Join-Path $logDir "v67_drain_b70_stderr.txt"
...
$reportOut = Join-Path $reportDir "v67_drain_b70_run_result.md"
...
Write-Host "=== JJFB v67 drain/B70 (2E2520 ret + 312C0C + 2FC26C) ==="
Write-Host "project=$root"
Write-Host "target: why B54 keeps code=5; natural path after 2FC26C; no FORCE B70"
...
if (-not $bridgeText.Contains("[JJFB_V67_DRAIN]") -or
    -not $bridgeText.Contains("[JJFB_V67_DRAWFP]") -or
  ...
  throw "v67 overlay missing (need V67_DRAIN + V67_DRAWFP + V66_101AB + V64_ENQ + FAMILY_APP2)."
}
...
Write-Host "[4/6] Build v67 drain/B70"
...
$pattern = "JJFB_V67_DRAIN|JJFB_V67_GATE|JJFB_V67_DRAWFP|after_2E2520|312C0C|gate_B70|enter_2FC26C|uimode_writer|strb_B70|FORCE state"
